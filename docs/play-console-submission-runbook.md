...
## 4. Privacy policy and support URLs

Before using these in Play Console:

1. Replace placeholders on the public pages
2. Publish the site
3. Verify both URLs load over HTTPS on desktop and Android
...
- Whether users can request deletion beyond deleting invoices individually
...
- Verify privacy and support URLs open correctly from mobile browser
